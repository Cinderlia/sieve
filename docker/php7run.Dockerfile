##################################################################################################################################
FROM sieve/baserun as php7run
##################################################################################################################################

COPY --from=sieve/php7build /usr/local/bin/php /usr/local/bin/php-config /usr/local/bin/phpize /usr/local/bin/php-cgi /usr/local/bin/phar.phar /usr/local/bin/phpdbg /usr/local/bin/
COPY --from=sieve/php7build /usr/local/lib/php/build/ /usr/local/lib/php/build/
...
RUN git clone https://github.com/malteskoruppa/phpjoern.git /phpjoern
